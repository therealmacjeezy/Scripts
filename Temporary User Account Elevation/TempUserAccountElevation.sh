...
Prompt_For_Smartcard() {
"/Library/Application Support/JAMF/bin/jamfHelper.app/Contents/MacOS/jamfHelper" \
-windowType utility -title "Smartcard Not Found" -description "Please insert your smartcard to begin." \
...
hash=$(sc_auth identities | grep PIV | awk '{print $1}' | tr '[:upper:]' '[:lower:]' | sed 's/.\{8\}/& /g' | sed 's/.$//g')
