...
# Database Name
dbHost='<database_location>'
# Database Password
dbPass='<database_password>'
# This array stores the names of your MySQL databases, if you only have one database for your setup, comment out the array on line 17 and uncomment the array on line 20
