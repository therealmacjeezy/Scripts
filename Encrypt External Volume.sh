...
###### Extension Attribute #######################################################
# In order to upload the encoded passphrase to the JSS you will need to create an
# extension attribute that will cat the log that is created and upload it to the 
# extension attribute field.
###### NOTES #####################################################################
# If you have any issues with the script, please send me an email and let me know
# where and what the issues is so I can resolve it. I am not responsible for any
# data loss that may occur while using this script.
##################################################################################
